...
public class BoidsPositionClampSystem : JobComponentSystem
{
    ...
    [BurstCompile]
    private struct BoidsPositionClampSystemJob : IJobForEach<Translation, BoidData>
    {
        ...
        public void Execute(ref Translation translation, ref BoidData boidData)
        {
    ...
    {
        BoidsPositionClampSystemJob job = new BoidsPositionClampSystemJob
        {
